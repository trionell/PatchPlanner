...
export const listInventoryItems = (params?: { categoryId?: number; categoryType?: string; role?: 'cable' | 'stand' | 'truss' }) => {
...
export const updateCategoryPickerRole = (categoryId: number, pickerRole: 'cable' | 'stand' | 'truss' | null) =>
